...
function addressCheck(){
    ...
    var error=false;
            if(selectedAddress==undefined){$('#error_shipping_address_general').html('Please select a shipping address.').removeAttr('hidden')}
...
function cardCheck(){
    ...
    var error=false;
     ...
     var error=false;
                if(selectedBilling==undefined){$('#error_billing_address_general').html('Please select a billing address.').removeAttr('hidden');}
...
if(products==0){return}
    ...
    for (var i = 0; i < products.length; i++) {
      product_id = products[i].id + products[i].color;
        tempCookieArray.push({id:products[i].id, quantity:products[i].quantity, color:products[i].color, stripe_price:products[i].stripe_price})
...
var isShipping=false;
   ...
   if(isShipping){
    ...
    $('<div class="shipping-new" data-age="new"  data-address="{&quot;delivery_postcode&quot;:&quot;"####"&quot;,&quot;delivery_address1&quot;:&quot;"####"&quot;,&quot;delivery_address2&quot;:&quot;"####"&quot;,&quot;delivery_city&quot;:&quot;"####"&quot;,&quot;names1&quot;:&quot;"####"&quot;,&quot;names2&quot;:&quot;"####"&quot;,&quot;phonenumber&quot;:&quot;"####"&quot;}"><div class="shipping-cover"></div><div class="shipping-button feedback"></div><div class="shipping-info"><div class="shipping-name">Use a different shipping address</div><div class="shipping-address"></div><div class="shipping-address"></div><div class="shipping-address"></div></div> </div>').appendTo($shippingAddress);
    
            
   $('<div class="billing-new" data-age="new"  data-address="{&quot;delivery_postcode&quot;:&quot;"####"&quot;,&quot;delivery_address1&quot;:&quot;"####"&quot;,&quot;delivery_address2&quot;:&quot;"####"&quot;,&quot;delivery_city&quot;:&quot;"####"&quot;,&quot;names1&quot;:&quot;"####"&quot;,&quot;names2&quot;:&quot;"####"&quot;,&quot;phonenumber&quot;:&quot;"####"&quot;}"><div class="billing-cover"></div><div class="shipping-button feedback"></div><div class="shipping-info"><div class="shipping-name">Use a different billing address</div><div class="shipping-address"></div><div class="shipping-address"></div><div class="shipping-address"></div></div> </div>').appendTo($billingAddress);
...
$(window).resize(function(){drawLine();})
