...
quantityConfirm(e.currentTarget.dataset.itemId).then((result)=>{
   ...
   product_ids_check.push({id:products[i].id, field:$("#quantity" + product_id), error:$('#availability' + product_id)})
...
return ($(this).val() == "") ? null : $(this).val();
      ...
      return a+b
        ...
        if(tempError){quantityError=true}else if(!tempError){quantityError=false}
